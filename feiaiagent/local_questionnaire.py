...
QUESTIONS_STRUCTURED = [
    ...
    {"id": "height", "text": "身高(cm)", "prompt": "您的身高是多少厘米？", "category": "身体指标"},
    {"id": "weight", "text": "体重(kg)", "prompt": "您的体重是多少公斤呢？", "category": "身体指标"},
    {"id": "smoking_history", "text": "吸烟史", "prompt": "请问您有吸烟的习惯吗？", "category": "吸烟史"},
    {"id": "smoking_freq", "text": "吸烟频率", "prompt": "您平均每天大概抽多少支烟？", "category": "吸烟史", "depends_on": {"id": "smoking_history", "value": "是", "values": ["是", "有", "吸烟", "抽过", "以前抽", "曾经抽"], "auto_fill": "0"}, "auto_fill_value": "0"},
    {"id": "smoking_years", "text": "累计吸烟年数", "prompt": "您总共吸了多少年烟呢？", "category": "吸烟史", "depends_on": {"id": "smoking_history", "value": "是", "values": ["是", "有", "吸烟", "抽过", "以前抽", "曾经抽"], "auto_fill": "0"}, "auto_fill_value": "0"},
    {"id": "smoking_quit", "text": "目前是否戒烟", "prompt": "那您现在是否已经戒烟了？", "category": "吸烟史", "depends_on": {"id": "smoking_history", "value": "是", "values": ["是", "有", "吸烟", "抽过", "以前抽", "曾经抽"], "auto_fill": "否"}, "auto_fill_value": "否"},
    {"id": "smoking_quit_years", "text": "戒烟年数", "prompt": "您戒烟有多少年了？", "category": "吸烟史", "depends_on": {"id": "smoking_quit", "value": "是", "values": ["是", "有", "戒了", "已经戒", "现在不抽"], "auto_fill": "0"}, "auto_fill_value": "0"},
    {"id": "passive_smoking", "text": "被动吸烟", "prompt": "在您的生活或工作环境中，您会经常吸到二手烟吗？", "category": "被动吸烟"},
    {"id": "passive_smoking_freq", "text": "被动吸烟频率", "prompt": "您大概每天会接触二手烟多长时间呢？", "category": "被动吸烟", "depends_on": {"id": "passive_smoking", "value": "是", "values": ["是", "有", "经常", "会", "接触", "吸到"], "auto_fill": "0"}, "auto_fill_value": "0"},
    {"id": "passive_smoking_years", "text": "累计被动吸烟年数", "prompt": "这种情况大概持续多少年了？", "category": "被动吸烟", "depends_on": {"id": "passive_smoking", "value": "是", "values": ["是", "有", "经常", "会", "接触", "吸到"], "auto_fill": "0"}, "auto_fill_value": "0"},
    {"id": "kitchen_fumes", "text": "长期厨房油烟接触", "prompt": "您平时做饭多吗？会经常接触厨房油烟吗？", "category": "厨房油烟"},
    {"id": "kitchen_fumes_years", "text": "累计厨房油烟接触年数", "prompt": "您接触厨房油烟有多少年了？", "category": "厨房油烟", "depends_on": {"id": "kitchen_fumes", "value": "是"}},
    ...
    {"id": "occupation_exposure_details", "text": "致癌物类型及累计接触年数(如有)", "prompt": "具体是哪种物质，大概接触了多少年？", "category": "职业暴露", "depends_on": {"id": "occupation_exposure", "value": "是"}},
    {"id": "personal_tumor_history", "text": "既往个人肿瘤史", "prompt": "请问您以前得过肿瘤吗？", "category": "肿瘤相关史"},
    {"id": "personal_tumor_details", "text": "肿瘤类型及确诊年份(如有)", "prompt": "可以具体说说肿瘤的类型和确诊年份吗？", "category": "肿瘤相关史", "depends_on": {"id": "personal_tumor_history", "value": "是"}},
    {"id": "family_cancer_history", "text": "三代以内直系亲属肺癌家族史", "prompt": "您的父母、兄弟姐妹或子女中，有人得过肺癌吗？", "category": "肿瘤相关史"},
    {"id": "family_cancer_details", "text": "肿瘤类型及关系(如有)", "prompt": "是哪位亲属，患的是哪种癌症呢？", "category": "肿瘤相关史", "depends_on": {"id": "family_cancer_history", "value": "是"}},
    ...
    {"id": "recent_weight_loss", "text": "近半年不明原因消瘦(1有 2无)", "prompt": "最近半年，您的体重有没有在没刻意减肥的情况下明显下降？", "category": "近期症状"},
    {"id": "recent_symptoms", "text": "最近是否有持续性干咳、痰中带血、声音嘶哑等", "prompt": "那最近有没有出现持续干咳、痰里带血、或者声音嘶哑这些情况呢？", "category": "近期症状"},
    {"id": "recent_symptoms_details", "text": "具体症状(如有)", "prompt": "能具体描述一下是什么症状吗？", "category": "近期症状", "depends_on": {"id": "recent_symptoms", "value": "是"}},
    {"id": "self_feeling", "text": "最近自我感觉(1好 2一般 3不好)", "prompt": "总的来说，您感觉最近身体状态怎么样？", "category": "健康自评"}
]
